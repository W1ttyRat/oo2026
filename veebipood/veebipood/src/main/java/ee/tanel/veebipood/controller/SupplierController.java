...
import ee.tanel.veebipood.dto.Supplier1Product;
import ee.tanel.veebipood.dto.Supplier2Product;
...
public class SupplierController {
    ...
    public List<Supplier2Product> getProductsSupplier2() {
        ...
        return Arrays.stream(response).sorted(Comparator.comparing(Supplier2Product::getPrice)).toList();
    }
}
